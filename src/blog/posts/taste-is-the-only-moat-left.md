---
layout: post.njk
title: Taste Is the Only Moat Left
description: AI made producing ads free. That made knowing which ad is good the most expensive skill in the building.
date: 2026-07-12
permalink: /blog/taste-is-the-only-moat-left/
---
...
Here's what that did to quality.
...
More stuff means more bad stuff. Publishing learned it first. Advertising is learning it right now.
...
Somebody still has to look at the hundred and pick the one. Somebody has to know why option 47 stops a thumb and option 12 gets scrolled past by every human alive.
...
- Generate wide. Twenty concepts where we used to afford three.
- Kill fast. Most die before a client ever sees them.
- Put real money behind the survivors and let buyers vote.

If your feed is full of ads that all look competent and none of them are pulling, that's a taste problem. [Book a strategy call](/#book-call) and we'll tell you which ones deserve your budget.
